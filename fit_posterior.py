...
def fit_posterior(id, region, sex, year):
    ...
    model.fit(dm, method='mcmc', keys=keys, iter=200000, thin=100, burn=100000, verbose=1, dbname='/dev/null')  # dbname was '%s/posterior/pickle/dm-%d-posterior-%s-%s-%s.pickle' % (dir, id, region, sex, year)
