\section{From systematic review to meta-regression}
To put the descriptive epidemiological meta-regression framework
developed in this book in its historical context, this chapter
provides a brief overview and introduction to systematic review and
meta-analysis.
...
review.\cite{moher_preferred_2009} PRISMA divides the systematic
...
As part of the GBD 2010 Study, groups of disease experts have
undertaken this process for each disease and risk factor to be
