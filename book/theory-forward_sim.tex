...
modeling \cite{hethcote_qualitative_1976,anderson_infectious_1991,
...
to speak for itself.  However, in the case of sparse and noisy data, data
models could benefit from additional structure.  Integrative
systems modeling is a framework to bring together a model of process
...
\caption{The two-compartment model of process for disease in a
  ...
  population flows out of the system with with-condition mortality
  hazard $h_m+h_f$, where $h_f$ is the excess mortality hazard,
  representing quantitatively the increase in mortality for
...
first glance.  All of the parameters of the model are functions of age
...
they will provide the integrative systems model for meta-regression
...
health system are regularly reported to the WHO; for
...
over all ages).  Caveats about case reports and health system
