...
industrial engineering \cite{TK original works on GM, city, globe,
  systems thinking primer}.  This type of compartmental modeling is
similar to infectious disease modeling \cite{andersen and may, rohit
  and premanji, vcycychy and, diekman and other} and pharmacokinetic
modeling \cite{jacquez1, jacquez2}.
