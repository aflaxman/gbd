...
Integrative systems modeling (ISM) combines a mechanistic model of process
with a statistical model of data.  The foundations of ISM are
...
h_m+h_f$.  TK: $h_{m_{with}}$ denominator v csmr denominator
