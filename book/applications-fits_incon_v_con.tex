...
This example focuses on ESRD dialysis patients because it has four different types of data, shown in Figure \ref{fig:app-CKD data}.  The majority of data are from studies or registry reports.  Countries a known lack of dialysis or transplantation with no other data available used data from the Genitourinary Expert Group.  The analysis includes a total of 5664 rows of data representing 161 countries in all 21 regions.  The distribution of dialysis epidemiologic parameter data types by region are shown in Table \ref{tab:CKD_data}. Transplantation incidence among the prevalent dialysis population was used as a proxy for remission.  The model combines hemodialysis and peritoneal dialysis for analysis.
