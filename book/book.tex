...
% format for notes to follow table
\newcommand{\mynote}[1]{\sffamily\emph{Note:} {#1}}
...
\begin{document}
\book*{An Integrative Metaregression Framework for Descriptive
  Epidemiology}
...
\chapterprecis{Abraham D. Flaxman, Theo Vos, and Christopher J. L. Murray}
\include{intro-intro}
