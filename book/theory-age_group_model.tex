...
\caption[The disaggregation approach applied to homogeneous and heterogeneous age
  groups.]{This figure shows the effects of fitting a model with my
...
\end{tabular}
\end{center}
\emph{Note:} Bias is the mean of truth minus predicted, median absolute
  error (MAE) is the median of absolute difference between truth and
  predicted, probability of coverage (PC) is the percent of truth falling
