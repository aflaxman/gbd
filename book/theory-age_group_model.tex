...
\[
r_{a_0,a_2} = \int_{=a_0}^{a_2} r_{a,a+da}n_{a,a+da}/n_{a_0,a_2}
\]
...
\begin{align*}
r_i, n_i &\sim \NBRate\left(\mu_i, \rho\right),\\
\mu_i &= \int_{a=a0_i}^{a1_i} \boldmu(a)dw(a),
\end{align*}
