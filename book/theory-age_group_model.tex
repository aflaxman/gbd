...
%\includegraphics[width=\textwidth]{af_ages_intervals.png}
\end{center}
...
from Chapter~\ref{theory-age_pattern_model} would work to produce a combined estimate that is as
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=\textwidth]{epilepsy_ages_intervals.png}
...
Figure~\ref{theory-age_group_model-dismod_data_plot-multiple} shows the age group data for a collection of other
condition/area/sex/year combinations.

\begin{figure}[ht]
\includegraphics[width=2in]{TK.png}
...
spline model of an age-specific rate from Chapter~\ref{theory-age_pattern_model}, and let
$\dens(r,n\given \pi, \rho)$ be the negative binomial rate model from
Chapter~\ref{theory-rate_model}.  Then the likelihood of an observation of rate $r_i$ with
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=\textwidth]{age_group_midpoint.png}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=\textwidth]{age_group_disagg.png}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=\textwidth]{age_group_midpoint_covariate.png}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=\textwidth]{age_group_standardize.png}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=\textwidth]{age_group_models.png}
