\chapter{Improving out-of-sample prediction: liver cirrhosis}
\label{applications-efx_country_level}
\chapterprecis{Ali Mokdad, Abraham D. Flaxman, Hannah M. Peterson, Christopher J. L. Murray, and Mohsen Naghavi}
    ...
    \begin{figure}[h]
        \begin{center}
            ...
            \caption[Cirrhosis prevalence estimates and available data
              for the USA and Egypt.]{Cirrhosis
              prevalence estimates and available data
              for (a) the USA and (b) Egypt, for males
...
the prevalence is much higher there than in the USA.  It
