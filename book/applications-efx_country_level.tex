...
high. \cite{garcia-tsao_management_2009, d'amico_natural_2006,
  schuppan_liver_2008}
    ...
    \begin{figure}[h]
        \begin{center}
            ...
            \caption{Available global data for cirrhosis prevalence
              (a) and cause-specific mortality (b).}
            \label{fig:app-cirrhosis data}
        \end{center}
    \end{figure}

Since cirrhosis is so deadly, it is a reasonable assumption that
