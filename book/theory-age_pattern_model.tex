...
Figure~\ref{ssas-mx_female_1990} shows the age-specific all-cause
mortality rate $m_{\all}$ for Southern sub-Saharan Africa, females, in
1990, which varies almost 1000-fold as a function of
age. Epidemiological rates vary between regions, times, and sexes as
well as age.  A figure like Figure~\ref{ssas-mx_female_1990} for the
Asia Pacific, High Income region in 1990 would look very different, as
