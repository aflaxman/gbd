...
and the location knots is practical and allows for users to
...
clipped version, $h^c(a) = \clip(h(a), \ell_0, \ell_1)$, and
...
for which experts often have strong priors about.
