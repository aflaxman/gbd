...
variant thereof.\cite{Metropolis, Hastings}
...
theoretical work, a ``warm-start'' increases performance by selecting inital values that are near the target values.  Ideally, warm-start values are from a distribution whiose density at any point is at most twice the density of the target distribution. \cite{lovasz_hit_2005, kannan_random_1996}  In practice, a number of different
...
recent developments in MCMC methods as well, including population
