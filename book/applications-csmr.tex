...
disease and those who die with the disease but not of the disease,
the compartmental model in Figure \ref{forward-sim-two-compartment}
can use the cause-specific mortality data that results from the
``one cause, one death'' GDB 2010 Study mantra.
