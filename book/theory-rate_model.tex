...
A central decision when modeling sparse, noisy epidemological data
...
alternative models for the metaanalysis of rates, ratios, and
durations.
...
rate is modeled as fixed across all populations.\cite{metaanalysis_book}
...
effects model in traditional metaanalysis\cite{metaanalysis_book} (or in linear regression\cite{stats_book}).  By introducing additional
