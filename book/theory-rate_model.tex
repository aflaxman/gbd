...
substantial effect on the estimated uncertainty, and can have a
...
model.  When modeling rates with non-sampling variation at the level
...
experience dictates that the non-sampling variation (parametrized by
...
imputing the missing uncertainty values to be as large as the 90th
...
systematic review\cite{TK_Epilepsy_EG_report} in the model likelihood.  This dataset
