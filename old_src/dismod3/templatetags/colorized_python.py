...
@register.filter(name='colorized_python')
def colorized_python(python_str):
    colorized_python = StringIO.StringIO()
    Parser(str(python_str), colorized_python).format(None, None)
    colorized_python.seek(0)
    return mark_safe(colorized_python.read())


"""
    MoinMoin - Python Source Parser
    By Jurgen Hermann
    Downloaded from http://code.activestate.com/recipes/52298/
"""
